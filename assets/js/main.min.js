jQuery(document).ready(function (e) {
  ...
  e("#preloder").delay(1e3).fadeOut("slow"),
    e(".hamburger").click(function () {
      e(".mobile-menu").addClass("_active"), e("body").addClass("_lock");
    }),
    e(".mobile-menu__close, .mobile-menu__list li a").click(function () {
      e(".mobile-menu").removeClass("_active"), e("body").removeClass("_lock");
    }),
    e(window).width() >= 992 &&
